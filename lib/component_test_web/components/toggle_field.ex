defmodule ComponentTestWeb.Components.ToggleField do
  @moduledoc """
  ComponentTestWeb.Components.ToggleField component renders a toggle field with customizable options.
