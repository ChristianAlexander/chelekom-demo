defmodule ComponentTestWeb.Components.CheckboxField do
  @moduledoc """
  ComponentTestWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ComponentTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ComponentTestWeb.Gettext, "errors", msg, opts)
    end
  end
end
